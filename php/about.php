...
echo <<<__END
            ...
            <div class="index-information">
                <h2 class="ms-2 text-center">About</h2>
                <article class="more-info">
                    <p><span class="h5"><i>Harvestors</i></span> is  a rental company for harvesting machineries.The company's headquarters are in Nakuru and its other branch is in Juja. 
                    The company is new and growing and we will add more machines with time.</p>
                    <div class="pb-3">
